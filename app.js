...
const flowPrincipal = addKeyword(['hola', 'ole', 'alo']).addAnswer(
    ...
    'Soy Daniela Sanchez, tu asistente virtual. Por favor indícame qué es lo que deseas hacer , marca el número de la opción que desear consultar.'
    ])
    .addAnswer (
        [     
            '1. Movilidad y transito🚗🚧',
            '2. Reclamos O Soporte📥',
        ],
        null,
        null,
