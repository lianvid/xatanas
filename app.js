...
const flowPrincipal = addKeyword(['hola', 'ole', 'alo','buenas']).addAnswer(
    [
    '👋Hola , gracias por comunicarte con Transmovil servicios',    
    '¡Nos alegra mucho tenerte aquí! 😊',
    'Visita nuestra página web para mayor información:',
    'https://transmovilservicios.online/',
    've también nuestra información legal como NIT, RUT y Cámara De Comercio:',
    'https://transmovilservicios.online/documentacion-legal/',
    'Soy Sara Sanchez, tu asistente virtual. Por favor indícame qué es lo que deseas hacer , marca el número de la opción que desear consultar.'
    ])
    .addAnswer (
        [   ' *Escribe la opción en palabra como se muestra, “no números”.*',  
